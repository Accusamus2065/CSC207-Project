...
public class WelcomeSignupControllerTest {
    ...
    public void executePatientTest() {
        WelcomeSignupInputBoundary signupInteractor = welcomeInputData -> assertFalse(welcomeInputData.isDoctor());
    ...
    public void executeDoctorTest() {
        WelcomeSignupInputBoundary signupInteractor = welcomeInputData -> assertTrue(welcomeInputData.isDoctor());
        WelcomeSignupController signupController = new WelcomeSignupController(signupInteractor);
