...
public class WelcomeLoginControllerTest {
    ...
    public void executePatientTest() {
        WelcomeLoginInputBoundary loginInputInteractor = welcomeInputData -> assertFalse(welcomeInputData.isDoctor());
    ...
    public void executeDoctorTest() {
        WelcomeLoginInputBoundary loginInputInteractor = welcomeInputData -> assertTrue(welcomeInputData.isDoctor());
        WelcomeLoginController welcomeLoginController = new WelcomeLoginController(loginInputInteractor);
