...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        PatientUpdateView patientUpdateView = PatientUpdateUseCaseFactory.create(entityDataAccessObject, viewManagerModel, patientUpdateViewModel, dialogflowViewModel, loginViewModel);
        views.add(patientUpdateView, patientUpdateView.viewName);
        ...
        ListOfPatientsView listOfPatientsView = ChoosePatientUseCaseFactory.create(viewManagerModel, conversationViewModel, docUpdateViewModel, choosePatientViewModel, loginViewModel, trainingViewModel, entityDataAccessObject);
